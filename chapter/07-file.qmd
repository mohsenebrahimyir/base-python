...
## جستجو در فایل {#sec-search-in-file}
...
## انتخاب نام فایل {#sec-select-file}
...
## استفاده از `try`، `except` و `open` {#sec-try-except-open-file}
