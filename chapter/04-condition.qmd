# اجرای شرطی {#sec-condition-statement}

## اجرای شرطی {#sec-condition-execution}
...
## اجرای جایگزین {#sec-alternative-execution}
...
## شرط‌های زنجیره‌ای {#sec-chained-conditionals}
...
## شرط‌های تو در تو {#sec-nested-conditionals}
...
## استفاده از `try` و `except` {#sec-try-except-statement}
...
- [یخدارچی - `3429`](https://quera.org/problemset/3429)
- [اعداد - `280`](https://quera.org/problemset/280)
- [مشق باقر - `10230`](https://quera.org/problemset/10230)
- [اعداد فیثاغورثی - 280](https://quera.org/problemset/280)
- [روز آزادی بیان در برره - ‍`10162`](https://quera.org/problemset/10162)
- [دو نقطه خط - `3414`](https://quera.org/problemset/3414)
:::
