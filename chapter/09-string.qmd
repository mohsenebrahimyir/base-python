...
## لیست‌ها و رشته‌ها {#sec-lists-strings}
...
## محاسبه طول متن {#sec-string-length}
...
## رشته‌ها تغییرناپذیرند {#sec-immutable-string}
...
## عملگر [`in`]{dir=ltr} {#sec-in-operation}
...
## متدهای رشته‌ای {#sec-string-methods}
